...
public class Hud : MonoBehaviour {
    ...
    private IRestart[] _restartObjects;
    ...
    public void RestarLevel() {
        foreach(IRestart restartObject in _restartObjects) restartObject.Restart();
    ...
    public IEnumerator ShowSuccessDisplay() {
        ...
        TimeSpan ts = TimeSpan.FromSeconds(Time.timeSinceLevelLoad - Player.Instance.initialTime);
